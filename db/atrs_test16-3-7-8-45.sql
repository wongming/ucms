...
# Database: atrs_test
# Generation Time: 2016-03-07 00:45:42 +0000
# ************************************************************
...
VALUES
	...
	(14,'sshdemo_file','Running','JavaWeb','SSH框架，没有maven，Repository Type是File',NULL,'http://localhost:8080/sshdemo_file','2016-03-03 14:52:20',0,'Success','/Users/wangming/workspace/atrs/workbench/release/log/20160303145220-sshdemo_file.log','release the app successfully','File','/Users/wangming/Documents/project/sshdemo');
...
VALUES
	...
	(6,'','','','','','',NULL),
	(7,'plan_true',X'636173655F747275653B636173655F7472756532','378406534@qq.com','','','this a successful plan',NULL);
