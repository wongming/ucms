...
var pageListShow = function (conf) {
    var pageInfo = {}; // The json object to save page information
    var initPageInfo = function (conf) {
        var confObj = conf;
        if ("pageSize" in confObj){
            pageInfo.pageSize = confObj.pageSize;
        } else {
            pageInfo.pageSize = 5;
        }
        if ("bufferSize" in confObj){
            pageInfo.bufferSize = confObj.bufferSize;
        } else {
            pageInfo.bufferSize = 10;
        }
        if ("postUrl" in confObj){
    ...
    var initPageListShow = function (conf) {
        initPageInfo(conf);
